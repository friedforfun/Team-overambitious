...
public class CameraMovement : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        else GetComponent<Camera>().cullingMask = (1 << LayerMask.NameToLayer("Minimap")) | (1 << LayerMask.NameToLayer("Wall")) | (1 << LayerMask.NameToLayer("Ground")); // Shows only the Minimap, Wall and Ground layers
    }
